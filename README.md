...
3. Please DO NOT use editors that introduce additional line break symbols.  
In emacs they show up as thousands of ^M symbols, one at the end of each line 
and make for a file that github considers as completely different, with no chance to automatically merge edits!